...
function kama_breadcrumbs( $sep = '', $l10n = array(), $args = array() ){
	...
	// Локализация
	$def_l10n = array(
		'home'       => __('Home', 'wpsampletemplate'),
		'paged'      => __('Page %d', 'wpsampletemplate'),
		'_404'       => __('Error 404', 'wpsampletemplate'),
		'search'     => __('Search results for - <b>%s</b>', 'wpsampletemplate'),
		'author'     => __('Author archive: <b>%s</b>', 'wpsampletemplate'),
		'year'       => __('Archive for <b>%d</b>', 'wpsampletemplate'),
		'month'      => __('Archive for: <b>%s</b>', 'wpsampletemplate'),
		'day'        => '',
		'attachment' => __('Media: %s', 'wpsampletemplate'),
		'tag'        => __('Posts by tag: <b>%s</b>', 'wpsampletemplate'),
		'tax_tag'    => __('%1$s from "%2$s" by tag: <b>%3$s</b>', 'wpsampletemplate'),
