...
function get_catalog_form( $none ) {
    ...
    <?php endif; ?>
            ...
            <h2 class="form__title"><?php echo esc_html__( 'Order', 'wpsampletemplate' ); ?></h2>
                ...
                <section class="form__content">
                        ...
                        <div class="form__item form__item--name">
                            <div class="form__input-bg">
                                ...
                                <input
                                    ...
                                    id="form__name"
                                    name="form__name"
                                    placeholder="<?php echo esc_html__( 'Contact information(*)', 'wpsampletemplate' ); ?>"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form__item form__item--email">
                            <div class="form__input-bg">
                                ...
                                <input
                                    ...
                                    id="form__email"
                                    name="form__email"
                                    placeholder="<?php echo esc_html__( 'Email(*)', 'wpsampletemplate' ); ?>"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form__item form__item--tel">
                            <div class="form__input-bg">
                                ...
                                <input
                                    ...
                                    id="form__tel"
                                    name="form__tel"
                                    placeholder="<?php echo esc_html__( 'Phone number(*)', 'wpsampletemplate' ); ?>"
                                    required>
                            </div>
                        </div>
                    ...
                    <div class="form__item form__item--textarea">
                        <textarea
                            ...
                            name="form__textarea"
                            rows="3"
                            placeholder="<?php echo esc_html__( 'Comments on the order:', 'wpsampletemplate' ); ?>"></textarea>
                    </div>

                    <div class="form__row form__row--order">

                        <div class="form__item form__item--product">
                            <label class="form__label" for="form__product"><?php echo esc_html__( 'Product(*):', 'wpsampletemplate' ); ?></label>
                            <select id="form__product" class="js-input form__product form__select" name="form__product">
                                <option disabled selected="selected" data-price="0"><?php echo esc_html__( 'Select a product:', 'wpsampletemplate' ); ?></option>
                                <?php
                        ...
                        <div class="form__item form__item--quantity">
                            <label class="form__label" for="form__quantity"><?php echo esc_html__( 'Quantity(*):', 'wpsampletemplate' ); ?></label>
                            <div class="form__input-bg">
                    ...
                    <div class="form__row form__row--price-all">
                        ...
                        <div class="form__item form__item--price-all">
                            <label class="form__label form__label--price-all" for="form__price-all"><?php echo esc_html__( 'Total:', 'wpsampletemplate' ); ?></label>
                            <input
                        ...
                        <div class="form__item form__item--btn">
                            ...
                            <label class="js-form__btn-submit form__btn-submit form__btn-submit--def" for="form__submit"><?php echo esc_html__( 'Get Order', 'wpsampletemplate' ); ?></label>
                        </div>
