 ...
 */
if ( ! function_exists( 'wpsampletemplate_getting_catalog_form_none' ) ) {
    function wpsampletemplate_getting_catalog_form_none() {
        return get_catalog_form( "none" );
    }
}
add_shortcode( 'catalog_form_none', 'wpsampletemplate_getting_catalog_form_none' );
 ...
 * @return string HTML-код формы.
 */
if ( ! function_exists( 'wpsampletemplate_getting_catalog_form' ) ) {
    function wpsampletemplate_getting_catalog_form() {
        return get_catalog_form( "visible" );
    }
}
add_shortcode( 'catalog_form', 'wpsampletemplate_getting_catalog_form' );
 ...
 */
if ( ! function_exists( 'wpsampletemplate_getting_button_catalog' ) ) {
    function wpsampletemplate_getting_button_catalog( $atts, $shortcode_content = null ) {
        $atts = shortcode_atts(
            array(
                'get' => '',
            ),
...
add_shortcode( 'btn', 'wpsampletemplate_getting_button_catalog' );
