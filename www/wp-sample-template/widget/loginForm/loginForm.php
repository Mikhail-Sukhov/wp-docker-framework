...
class LoginForm extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__( 'Login Form', 'wpsampletemplate' ), // Название виджета
			array( 'description' => esc_html__( 'Login Form', 'wpsampletemplate' ) ) // Описание виджета
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title_form' ) ); ?>"><?php esc_html_e( 'Heading', 'wpsampletemplate' ); ?></label>
			<input
				class="widefat"
 ...
 */
if ( ! function_exists( 'wpsampletemplate_login_form_load' ) ) {
	function wpsampletemplate_login_form_load() {
		register_widget( 'LoginForm' );
	}
}
add_action( 'widgets_init', 'wpsampletemplate_login_form_load' );
