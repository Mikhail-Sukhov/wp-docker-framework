...
class LatestNews extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__( 'Latest news', 'wpsampletemplate' ), // Название виджета
			array( 'description' => esc_html__( 'Latest news', 'wpsampletemplate' ) ) // Описание виджета
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title_widget' ) ); ?>"><?php esc_html_e( 'Heading', 'wpsampletemplate' ); ?></label>
			<input
				class="widefat"
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'widget_num' ) ); ?>"><?php esc_html_e( 'Number of news items', 'wpsampletemplate' ); ?></label>
			<input
				class="tiny-text"
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'post_category' ) ); ?>"><?php esc_html_e( 'Select the category', 'wpsampletemplate' ); ?></label>
		...
		<p>
			<label><?php esc_html_e( 'Show an Image', 'wpsampletemplate' ); ?></label><br>
			<input
				type="radio"
			...
			/>
			<label for="<?php echo esc_attr( $this->get_field_id( 'widget_img_yes' ) ); ?>"><?php esc_html_e( 'Yes', 'wpsampletemplate' ); ?></label>
			<br>
			<input
				type="radio"
			...
			/>
			<label for="<?php echo esc_attr( $this->get_field_id( 'widget_img_no' ) ); ?>"><?php esc_html_e( 'No', 'wpsampletemplate' ); ?></label>
		</p>
 ...
 */
if ( ! function_exists( 'wpsampletemplate_latest_news_load' ) ) {
	function wpsampletemplate_latest_news_load() {
		register_widget( 'LatestNews' );
	}
}
add_action( 'widgets_init', 'wpsampletemplate_latest_news_load' );
