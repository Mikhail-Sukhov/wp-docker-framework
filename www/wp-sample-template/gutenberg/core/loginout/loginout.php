 ...
 * 
 */
if ( ! function_exists( 'wpsampletemplate_custom_modify_render_block_core_loginout' ) ) {
   function wpsampletemplate_custom_modify_render_block_core_loginout($block_content, $block) {
...
add_filter('render_block_core/loginout', 'wpsampletemplate_custom_modify_render_block_core_loginout', 10, 2);
