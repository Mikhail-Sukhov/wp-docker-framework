...
if ( ! function_exists( 'wpsampletemplate_customizer_addition' ) ) {

function wpsampletemplate_customizer_addition($wp_customize) {

   // Панели
   //-----------------------------------------------------------------------------------------------------//
   $wp_customize->add_panel( "theme_panel", array(
		"priority" => 1,
		"title" => esc_html__( 'Theme settings', 'wpsampletemplate' ),
		"description" => esc_html__( 'Theme settings', 'wpsampletemplate' ),
	));
   ...
   //-----------------------------------------------------------------------------------------------------//
	$wp_customize->add_section("about_section", array(
	  "title" => esc_html__( 'General settings', 'wpsampletemplate' ),
	  "priority" => 5,
     "panel" => "theme_panel"
	));
   ...
   // Слоган
	...
	$wp_customize->add_control("about_slogan", array(
	  ...
	  "label" => esc_html__( 'Slogan', 'wpsampletemplate' )." [about slogan]",
	));
   ...
   // Телефон 1
	...
	$wp_customize->add_control("about_tel_1", array(
	  "type" => "input",
	  "section" => "about_section",
	  "label" => esc_html__( 'Phone number', 'wpsampletemplate' )." 1 [about tel_1]",
	));
   ...
   // Телефон 1(ссылка)
	...
	$wp_customize->add_control("about_tel_1_href", array(
      "type" => "input",
      "section" => "about_section",
      "label" => esc_html__( 'Phone number href', 'wpsampletemplate' )." 1 [about tel_1_href]",
	));
   ...
   $wp_customize->add_setting("about_tel_2", array(
    ...
    $wp_customize->add_control("about_tel_2", array(
      "type" => "input",
      "section" => "about_section",
      "label" => esc_html__( 'Phone number', 'wpsampletemplate' )." 2 [about tel_2]",
    ));
   ...
   // Телефон 2(ссылка)
	...
	$wp_customize->add_control("about_tel_2_href", array(
      "type" => "input",
      "section" => "about_section",
      "label" => esc_html__( 'Phone number href', 'wpsampletemplate' )." 2 [about tel_2_href]",
	));
   ...
   // Почта
	...
	$wp_customize->add_control("about_mail", array(
	  "type" => "input",
	  "section" => "about_section",
	  "label" => esc_html__( 'Mail', 'wpsampletemplate' )." [about mail]",
	));
   ...
   // Адрес
	...
	$wp_customize->add_control("about_adress", array(
	  "type" => "input",
	  "section" => "about_section",
	  "label" => esc_html__( 'Address', 'wpsampletemplate' )." [about address]",
	));
   ...
   $wp_customize->add_control("about_adress_script", array(
      "type" => "textarea",
      "section" => "about_section",
      "label" => esc_html__( 'Address script', 'wpsampletemplate' )." [about address_script]",
   ));
   ...
   // Фирма
	...
	$wp_customize->add_control("about_firm", array(
	  "type" => "input",
	  "section" => "about_section",
	  "label" => esc_html__( 'Firm', 'wpsampletemplate' )." [about firm]",
	));
   ...
   $wp_customize->add_control("about_firm_text", array(
      "type" => "textarea",
      "section" => "about_section",
      "label" => esc_html__( 'About firm', 'wpsampletemplate' )." [about firm_text]",
   ));
   ...
   //-----------------------------------------------------------------------------------------------------//
	$wp_customize->add_section("home_page_section", array(
      "title" => esc_html__( 'Homepage Settings', 'wpsampletemplate' ),
      "priority" => 10,
      "panel" => "theme_panel"
   ));
   ...
   $wp_customize->add_control( "home_page_temp", array(
      ...
      "label" => esc_html__( 'Page Template', 'wpsampletemplate' ),
      "type" => "select",
      "choices" => [
         "" =>  esc_html__( 'Blog', 'wpsampletemplate' ),
         "table" =>  esc_html__( 'Table', 'wpsampletemplate' )
      ]
   ));
	...
	$wp_customize->add_control("home_page_number", array(
	  "type" => "number",
	  "section" => "home_page_section",
	  "label" => esc_html__( 'Number of posts', 'wpsampletemplate' ),
	));
   ...
   $wp_customize->add_control( "home_page_col", array(
      "section" => "home_page_section",
      "label" => esc_html__( 'Blog columns', 'wpsampletemplate' ),
      "type" => "select",
      "choices" => array(
         "post--col-1" => "1",
         "post--col-2" => "2",
   ...
   $wp_customize->add_section("search_page_section", array(
      "title" => esc_html__( 'Search Page Settings', 'wpsampletemplate' ),
      "priority" => 15,
      "panel" => "theme_panel"
   ));
   ...
   $wp_customize->add_section("category_page_section", array(
      "title" => esc_html__( 'Category Page Settings', 'wpsampletemplate' ),
      "priority" => 20,
      "panel" => "theme_panel"
   ));
   ...
   $wp_customize->add_section("archive_page_section", array(
      "title" => esc_html__( 'Archive Page Settings', 'wpsampletemplate' ),
      "priority" => 25,
      "panel" => "theme_panel"
   ));
   ...
   $wp_customize->add_section("price", array(
      "title" => esc_html__( 'Services', 'wpsampletemplate' ),
      "priority" => 25,
      "panel" => "theme_panel"
   ));
   ...
   // Массив услуг через textarea
    ...
    $wp_customize->add_control("priceArray", array(
      "type" => "textarea",
      "section" => "price",
      "label" => esc_html__( 'Services labels', 'wpsampletemplate' ),
      "description" => esc_html__( 'Array of service labels', 'wpsampletemplate' )." [price price=slug]",
   ...
   foreach($slugsArray as $i) {
      ...
      $wp_customize->add_control("price_name_{$i}", array(
         "type" => "input",
         "section" => "price",
         "label" => esc_html__( 'Name of the service', 'wpsampletemplate' )." [price_name get={$i}]",
      ));
      ...
      $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, "price_image_{$i}", array(
         "label" => esc_html__( 'Service image', 'wpsampletemplate' ),
         "section" => "price",
      ...
      $wp_customize->add_control("price_url_{$i}", array(
         "type" => "input",
         "section" => "price",
         "label" => esc_html__( 'Service href', 'wpsampletemplate' )." [price_url get={$i}]Some text[/price_url]",
      ));
      ...
      $wp_customize->add_control("price_number_{$i}", array(
         "type" => "number",
         "section" => "price",
         "label" => esc_html__( 'Price of services', 'wpsampletemplate' )." [price_num get={$i}]",
      ));
      ...
      $wp_customize->add_control("price_textarea_{$i}", array(
         "type" => "textarea",
         "section" => "price",
         "label" => esc_html__( 'Service description', 'wpsampletemplate' ),
      ));
...
add_action("customize_register", "wpsampletemplate_customizer_addition");
