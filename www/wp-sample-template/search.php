...
<section class="m-search">
	...
	<h2 class="m-search__title"><?php echo esc_html__( 'You were looking for:', 'wpsampletemplate' ); ?> "<?php the_search_query(); ?>"</h2>
	...
	<div class="m-search__box">
		...
		<?php if ( have_posts() ) : ?>
			...
			<h2 class="m-search__result"><?php echo esc_html__( 'Search Results:', 'wpsampletemplate' ); ?></h2>
	...
	<main class="main row" role="main">
		...
		<?php else : ?>
			<div class="m-search__mess">
				<p class="m-search__err"><?php echo esc_html__( 'The search did not produce any results', 'wpsampletemplate' ); ?></p>
			</div>
		</div>
	</section>
		<?php endif; ?>
